...
// projectWithFiles writes infrena.yml plus any extra files, keyed by path
...
`, map[string]string{
	...
	// This is a fresh project, so the plan proposes creates: exit 2 is changes,
	// not failure, which would be exit 1.

...
# internal/version. A hand-maintained constant would be wrong by the
...
# importing any infrena package (`go list -deps ./tests/integration` prints
...
# output is
#     FAIL infrena/internal/cli
#     FAIL infrena/internal/executor
#     ok   infrena/tests/integration  (cached)

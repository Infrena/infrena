// Package semver parses the version constraints configuration may state: a floor on
// infrata itself (`infrata: ">= 0.4"`) and a range on a provider plugin
// (`plugins: {aws: ">= 0.3.0, < 0.4.0"}`). PLAN.md §61.2.
//

...
// TestHashIgnoresScope.
//
// ConfigHash answers "was this plan computed against this configuration", so it
// must capture the RESOLVED VALUE and nothing about how the value arrived. A
// value of 20 is the same input whether it came from variables.yml or from
// --var, so hashing Scope would make an UNCHANGED configuration read as stale
// and a saved plan refuse to apply.
//

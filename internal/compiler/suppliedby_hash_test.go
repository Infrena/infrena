...
// TestHashIgnoresSuppliedBy mirrors TestHashIgnoresScope. A value of 20 is the
// same input whether --var or --var-file supplied it, so hashing SuppliedBy
// would make an unchanged configuration read as stale — a saved plan would
// refuse to apply because the user passed the same number through a different
// flag.
//
...
// Adding "supplied_by" beside them is the single-line change this test exists
// to catch.

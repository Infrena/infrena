...
// TestAVersionOutsideTheConstraintIsRefused, naming both numbers — a reader needs what
// they have as well as what is wanted.
...
// TestAPluginReportingNoVersionGetsItsOwnMessage.
//
...
// TestAnUnconstrainedPluginLoadsWhateverIsThere — `plugins:` is optional, and a project
// that states nothing must behave exactly as before it existed.
...
// TestARefusedPluginIsShutDownNotLeftRunning.
//
...
// TestTheRefusalIsCachedSoAProjectHearsItOnce. A project naming one bad plugin on twenty
// resources should say so once.

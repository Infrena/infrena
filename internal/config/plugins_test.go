...
// The `plugins:` block: a version constraint per plugin.
...
// The mapping form is additive: a project may also say where a plugin comes
// from.
...
// points at the line in infrena.yml rather than surfacing later from an install.

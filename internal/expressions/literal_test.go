...
// a scanner that does not track literal depth splits this into three arguments.
...
// TestALiteralOutsideAnArgumentIsRefused is the bound: the language does not
// gain general-purpose literals.

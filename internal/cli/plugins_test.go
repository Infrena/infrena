...
// The `plugins:` block, exercised through a command — which is the WIRING, and
// it was the gap: the loader's own tests construct a Loader directly, so
// buildRegistry could stop passing the constraints along and nothing would
// notice.

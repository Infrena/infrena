...
// The network is never on the hot path, and this is the check that keeps that
// true rather than merely intended: the HTTP client belongs in a package above
// this one, and the day something puts one inside it, this fails and names the
// import.
//
...
// itself, which is what makes such a call possible at all. Neither subsumes
// the other.

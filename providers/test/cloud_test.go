...
// The load-mutate-save cycle from several goroutines at once.
//
...
// and refresh reads every resource in state concurrently.
...
// Concurrent readers paired with concurrent writers. begin() saves on the read
// path too, so without atomicity a reader can observe a truncated file and
...
// The same discipline internal/state holds itself to: mode 0600, and no
